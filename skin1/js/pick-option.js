...
(function () {
    ...
    function _rowHTML(group, counts) {
        if (!U)
            return "";
    ...
    function _bindEvents() {
        ...
        new MutationObserver(function () {
            ...
            setTimeout(function () {
                if (C24)
                    C24.clearStaleSelections(groups, listRoot);
            }, 50);
